...
[![Release](https://github.com/aerglonus/jellyfin-plugin-letterboxd/actions/workflows/release.yml/badge.svg)](https://github.com/aerglonus/jellyfin-plugin-letterboxd/actions/workflows/release.yml)
...
2. Add a new repository:
   - **Name:** `LetterboxdSync`
   - **URL:** `https://raw.githubusercontent.com/aerglonus/jellyfin-plugin-letterboxd/main/manifest.json`
3. Go to **Catalog**, find **LetterboxdSync**, and click **Install**
4. Restart Jellyfin

### Manual install

1. Download the latest ZIP from [Releases](https://github.com/aerglonus/jellyfin-plugin-letterboxd/releases)
...
```bash
git clone https://github.com/aerglonus/jellyfin-plugin-letterboxd.git
